...
INSERT INTO "new_Settings" ("createdAt", "excludeGiftCards", "excludeOutOfStock", "fallbackVariantIds", "id", "limit", "manualVariantIds", "redirectToCart", "shop", "updatedAt", "upsellMode") SELECT "createdAt", "excludeGiftCards", "excludeOutOfStock", "fallbackVariantIds", "id", "limit", "manualVariantIds", "redirectToCart", "shop", "updatedAt", "upsellMode" FROM "Settings";
DROP TABLE "Settings";
